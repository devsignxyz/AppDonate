...
//create donors
.controller("DonorController", ["$scope",  "donorFactory","$state", "$stateParams","newdonorFactory" ,function  ($scope, $state, $stateParams, newdonorFactory ) {
...
//Search 
 ...
 .controller("findDonorController", ["$scope","donorFactory","newdonorFactory", "$routeParams","$stateParams","$state",  function ($scope, donorFactory ) 
                                     {
        donorFactory.query(
        function (response) {
...
///////////////PERFIL DETAILS//////////
    ...
    .controller("PerfilDetailsController", ["$scope", "$state", "$stateParams", "favoriteFactory","donorFactory", "newdonorFactory",  function ($scope, $state, $stateParams, newdonorFactory, donorFactory ) {
